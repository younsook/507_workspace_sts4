...
public class BoardRepositoryTest {
	 ...
	 * 
	 * Member member2 = new Member(); member2.setId("amdin");
	 ...
	 * board.setMember(member1); board.setTitle(member1.getName()+"가 등록한 게시글 "+i);
	 * board.setContent(member1.getName()+"가 등록한 게시글 "+i); boardRepo.save(board); }
	 * 
	 * for(int i =1; i<=3; i++) { Board board = new Board();
	 * board.setMember(member2); board.setTitle(member2.getName()+"가 등록한 게시글 "+i);
	 * board.setContent(member2.getName()+"가 등록한 게시글 "+i); boardRepo.save(board); }
	 * 
	 * }
	 */
